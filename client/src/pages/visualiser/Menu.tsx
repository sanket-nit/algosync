...
const Menu = () => {
  ...
  function generateRandomArray() {
    ...
    const newArray = Array.from({ length: arraySize[0] }, () => Math.floor(Math.random() * (MAX_VALUE - MIN_VALUE + 1)) + MIN_VALUE);
  ...
  return (
    <div className='row-span-1 lg:col-span-3 flex flex-col gap-6'>
        ...
        <div className='grid gap-4'>
          <Button onClick={generateRandomArray} disabled={inProcessRef.current}>Generate Array</Button>
